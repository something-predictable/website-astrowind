...
import DListItem from '@riddance/astrowind/components/ui/DListItem.astro';
import ToggleTheme from '@riddance/astrowind/components/common/ToggleTheme.astro';
...
```astro
import MyComponent from "astrowind/src/components/MyComponent"; ...
